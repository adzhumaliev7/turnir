...
class TeamsController extends Controller
{
    public function show($teamId) {
        ...
        $team = Team::with('teammates.turnir', 'teammates.user', 'teammatesTeam.user', 'сaptain', 'network',
            'groups.tournamentMatchesResults.matche', 'groups.turnir', 'groups.stage', 'groups.group')->findOrFail($teamId);
        $countMathe = 0;
...
//        ВЫНЕСТИ В КОНФИГ
        ...
        return view('admin.home.teams.show', compact('team', 'countMathe', 'userStatus'));
    }
