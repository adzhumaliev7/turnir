                        ...
                        @foreach($members as $members)
                                ...
                                <div class="member-block d-flex justify-content-between member-block--border-b my-4 ">
                                    <div class="member__item d-flex align-items-center">
                                        ...
                                        <span class="item__tile item__tile--margin">{{$members->login}}</span>
                                    </div>
                                      @if($members->role=='captain')
                                    <button class="btn--absl">
                                       <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    @else
                                     <div class="">
                                      <a href="#" class="orange item__tile item__tile--mr">apply admin</a>
