    ...
    <div class="tab-content tab-panels" id="nav-tabContent">
      ...
      @if(Session::has('flash_meassage_delete'))
                ...
                @if($chek_admin == 'true')
                    ...
                    <input class="subtitle subtitle--regular url-input url-input--margin" type="text" id="myInput" value="showmatch2/public/{{$link}}/{{$team_id}}">
                 ...
                 @endif
                    ...
                    <div class="member-block d-flex justify-content-between member-block--border-b my-4 ">
                        ...
                        <div class="">
                             <a href="{{route('add_admin', [$member->user_id, $team_id, $user_id])}}" class=" item__tile " onclick="return alert();">admin |</a>
