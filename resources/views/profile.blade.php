    ...
    <header>
      <div class="profile-bg h-100 header--pb header margin--none">
        ...
        <div class="container header-container">
          <div class="header-sz">
            <div
              class="header__panel d-flex justify-content-center align-items-center flex-sm-nowrap flex-wrap"
            >
    ...
    <main>
      <div class="profile__accordion">
        <div class="container">
          <nav>
            <div
              class="flex-wrap d-flex justify-content-start nav nav-tabs line--none flex-sm-nowrap"
              id="nav-tab"
              role="tablist"
            >
              <button
        ...
        <div class="tab-content tab-panels" id="nav-tabContent">
              @if(Session::has('flash_meassage'))
                  ...
                  @endif 
          <div
            class="tab-pane overflow-hidden fade show active"
            id="nav-home"
            role="tabpanel"
          ...
          >
            ...
            <table class="table indent--row table-block">
              <tbody>
               ...
               {{$tournament->name}}
                  ...
                  <td class="subtitle fw-normal">4x4</td>
                  <td class="subtitle fw-norma l">512/512</td>
                  ...
                  <td>
                    <button class="button--none">
                      ...
                      >
                        <path
                          d="M12.2708 14.25H11.4792C11.2606 14.25 11.0833 14.4272 11.0833 14.6458V17.4167H1.58335V1.58335H11.0833V4.35419C11.0833 4.5728 11.2606 4.75004 11.4792 4.75004H12.2708C12.4895 4.75004 12.6667 4.5728 12.6667 4.35419V1.58335C12.6667 0.7089 11.9578 0 11.0833 0H1.58335C0.7089 0 0 0.7089 0 1.58335V17.4167C0 18.2911 0.7089 19 1.58335 19H11.0833C11.9578 19 12.6667 18.2911 12.6667 17.4167V14.6458C12.6667 14.4272 12.4895 14.25 12.2708 14.25Z"
                          fill="black"
                        ></path>
                        <path
                          d="M18.8717 9.20817L14.1217 4.85402C14.0057 4.74848 13.8376 4.7195 13.6949 4.78366C13.5511 4.84667 13.4583 4.98891 13.4583 5.14585V5.93754C13.4583 6.04965 13.5059 6.15671 13.5894 6.23171L16.3411 8.70839H5.14585C4.92705 8.70839 4.75 8.88543 4.75 9.10423V9.89588C4.75 10.1147 4.92705 10.2917 5.14585 10.2917H16.3411L13.5894 12.7684C13.5059 12.8434 13.4583 12.9505 13.4583 13.0626V13.8542C13.4583 14.0112 13.5511 14.1534 13.6949 14.2164C13.7459 14.2392 13.8005 14.25 13.8542 14.25C13.9512 14.25 14.0471 14.2141 14.1217 14.1461L18.8717 9.7919C18.9536 9.71691 19 9.611 19 9.50004C19 9.38908 18.9536 9.28317 18.8717 9.20817Z"
                          fill="black"
                        ></path>
                      </svg>
                    </button>
            ...
            <div class="button-blocks button d-flex justify-content-center">
                <button class="accordion__btn nav-link mt-5">Все турниры</button>
              </div>
          </div>
          <div
            class="tab-pane fade"
