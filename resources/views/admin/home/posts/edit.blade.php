...
<div class="container">
<form action = "{{route('admin.posts.update' ,$post_id)}}" method="POST" >
   @csrf
  ...
  <div class="form-group">
    ...
    <textarea  name="text" class="form-control rules" id="exampleFormControlInput1" value="">{{$posts->text}}</textarea>
     @error('description')
